...
# 加载模型
net = caffe.Net('/home/fyb/caffe-tools-master/examples/bsds500/test.prototxt', '/home/fyb/caffe-tools-master/examples/bsds500/snapshot_iter_9500.caffemodel', caffe.TEST)

print("type:{}  ,  shape:{}".format(type(net.blobs['data'].data), net.blobs['data'].data.shape))
# 加载图像
save_path = "/home/fyb/PEdgerPlus/edges_caffetraining/"
